...
function (_Component) {
  ...
  function Cart(props) {
    ...
    __WEBPACK_IMPORTED_MODULE_4_axios___default.a.get('http://localhost:3002/cookie').then(function (response) {
      __WEBPACK_IMPORTED_MODULE_4_axios___default.a.get("http://localhost:3002/cart/cart_food/".concat(response.data)).then(_this.setState({
        data: response.data
      }));
    });
    return _this;
  ...
  _createClass(Cart, [{
    ...
    value: function componentDidMount() {
      ...
      __WEBPACK_IMPORTED_MODULE_4_axios___default.a.get('http://localhost:3002/cookie').then(function (response) {
        __WEBPACK_IMPORTED_MODULE_4_axios___default.a.get("http://localhost:3002/cart/cart_food/".concat(response.data)).then(_this2.setState({
          data: response.data
        }));
      });
    }
...
//# sourceMappingURL=6.67fe29e3b9c11baf46ea.hot-update.js.map