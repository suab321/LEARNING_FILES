  ...
  _createClass(User, [{
    ...
    value: function logout() {
      __WEBPACK_IMPORTED_MODULE_3_axios___default.a.get('http://localhost:3002/logout').then(function (response) {
        if (response.data === 'ok') {
          console.log('ok');
          __WEBPACK_IMPORTED_MODULE_3_axios___default.a.get('http://localhost:3002/get_login'.credentials = 'include');
        }
      });
    }
  }, {
...
//# sourceMappingURL=4.9429f4528cb502b67690.hot-update.js.map