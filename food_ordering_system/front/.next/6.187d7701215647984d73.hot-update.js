  ...
  _createClass(Cart, [{
    ...
    value: function remove(name) {
      __WEBPACK_IMPORTED_MODULE_4_axios___default.a.get('http://localhost:3002/cookie').then(function (response) {
        __WEBPACK_IMPORTED_MODULE_4_axios___default.a.get("http://localhost:3002/cart/remove/".concat(response.data, "/").concat(name));
      });
    }
  }, {
    key: "set",
...
//# sourceMappingURL=6.187d7701215647984d73.hot-update.js.map