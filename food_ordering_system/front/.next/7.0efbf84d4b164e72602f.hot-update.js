...
function (_Component) {
  ...
  function Cart(props) {
    ...
    __WEBPACK_IMPORTED_MODULE_4_axios___default.a.get("http://localhost:3002/cart/cart_food/".concat(_this.state.id)).then(function (response) {
  ...
  _createClass(Cart, [{
    ...
    value: function componentDidMount() {
      ...
      __WEBPACK_IMPORTED_MODULE_4_axios___default.a.get("http://localhost:3002/cart/cart_food/".concat(this.state.id)).then(function (response) {
        console.log(response.data);
      });
    }
  }, {
...
//# sourceMappingURL=7.0efbf84d4b164e72602f.hot-update.js.map