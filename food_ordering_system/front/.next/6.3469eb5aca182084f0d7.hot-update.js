...
function (_Component) {
  ...
  _createClass(Cart, [{
    ...
    value: function render() {
      var boxes = this.state.data[0].order;
      console.log(boxes);
...
//# sourceMappingURL=6.3469eb5aca182084f0d7.hot-update.js.map