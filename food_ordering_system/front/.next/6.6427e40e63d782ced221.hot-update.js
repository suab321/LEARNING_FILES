  ...
  _createClass(Cart, [{
    ...
    value: function render() {
      ...
      __WEBPACK_IMPORTED_MODULE_4_axios___default.a.get('http://localhost:3002/cookie').then(function (response) {
        __WEBPACK_IMPORTED_MODULE_4_axios___default.a.get("http://localhost:3002/cart/cart_food/".concat(response.data)).then(box = response.data.map(function (item) {
...
//# sourceMappingURL=6.6427e40e63d782ced221.hot-update.js.map