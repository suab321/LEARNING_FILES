...
const user=new mongoose.Schema({email:{type:String,unique:true,required:true},password:{type:String,required:true},
    order:[{name:String,price:Number,date:Date,category:String,url:String}],
    order_placed:[{orders:[{name:String,price:String,Number:String,date:Date,category:String,url:String}]}]})
